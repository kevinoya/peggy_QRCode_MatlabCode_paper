...
y5=imread('171220scan.jpg');
 y5a=rot90(rgb2gray(y5(:,100:100+700,:)));   % 抓第一章影像
 y5a=rot90(rgb2gray(y5(:,700:700+700,:)));   % 抓第2章影像
 y5a=rot90(rgb2gray(y5(:,1400:1400+700,:)));   % 抓第3章影像
 y5a=rot90(rgb2gray(y5(:,2100:2100+700,:)));  % 抓第4章影像
 y5a=rot90(rgb2gray(y5(:,2700:2700+700,:)));
...
data0=flipud(uint8(kk)>150);  % 99x99 calculated data

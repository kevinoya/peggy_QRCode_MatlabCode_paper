...
% y5=imread('171220scanK.jpg');
y5=imread('L171227.jpg');
 y5a=(rgb2gray(y5(150:850,150:150+700,:)));   % 抓第一章影像
 y5a=(rgb2gray(y5(2800:500+3000,150:150+700,:)));   % 抓第5章影像
 %y5a=rot90(rgb2gray(y5(:,600:600+700,:)));   % 抓第2章影像
 %y5a=rot90(rgb2gray(y5(:,1300:1300+700,:)));   % 抓第3章影像
 %y5a=rot90(rgb2gray(y5(:,2000:2000+700,:)));  % 抓第4章影像
% y5a=rot90(rgb2gray(y5(:,2500:2600+650,:)));

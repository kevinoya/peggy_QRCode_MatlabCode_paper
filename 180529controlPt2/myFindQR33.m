...
figure(3),subplot(2,2,1),imshow(y5a);subplot(2,2,2),imshow(y5b);
...
subplot(2,2,3),imshow(m2);subplot(2,2,4),imshow(m3);
mask1=m3/sum(sum(m3));
[m1 n1]=size(y5b);
y6=conv2(double(y5b),mask1,'same');   % m1 x n1 % 'same' : Return the central part of the convolution, which is the same size as A.

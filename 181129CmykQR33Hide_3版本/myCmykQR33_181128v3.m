...
aa=(660-348)/2;
k5=k5a(aa+1:aa+348,aa+1:aa+348,:);   % 只抓出 396x396 做加密處理
zz=myQR33HideColorB_181128v3(k5,y29,m7);   % <=====  主要處理程序
%
k5a(aa+1:aa+348,aa+1:aa+348,:)=zz;
...
binL=imread('binQR29_660.tif');
LL=imread('QRfinderColor_v3.tif');  % 黑白
LL1=LL(:,:,1)==0;  % binary

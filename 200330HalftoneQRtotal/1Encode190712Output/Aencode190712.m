...
%
 ...
 %
 %  
  R=imread('20220423_R1.tif');
  G=imread('20220423_G1.tif');
  B=imread('20220423_B1.tif');
  out = CombineRGB(Imgcls,R,G,B);
  outUnit8 = im2uint8(out,'indexed');
  imshow(outUnit8);
  imwrite(outUnit8,'20220423_combine3.tif');
 % 
...
%
imwrite(k22,'20220423_B1.tif','Resolution',600);  % output binary 165x165
...
%
imwrite(k5,'20220423_B2.tif','Resolution',600);  % output color 660x660x3
figure(2),imshow(k5);

...
function res=myErrorAnalysisQR123mask(data,y123,key);
...
figure(10),a1=myDecodeKey(data,key);        %  辨識的 2nd QR 33
a2=myQR41temp33(a1);
%
%qr2b=imread('dummyQR41.tif');   % 真實藏的 2nd QR
qr2b=myDecodeKey(y123,key);  % 41x41
b2=myQR41temp33(qr2b);    % 33x33
%
y1=(b2==a2);   % QR_2 error map
%
qr33_matrix;  % 產生 a 33x33 codeword label
dat2=myErrorCodeword33(y1,a);

...
%  input QR
%
filename='TW-2131570.png';  % input QR code
y=imread(filename);   
y1=(y==0);  % 147x147 binary   [ (4+41+4)*3  X  (4+41+4)*3 ]
% 
y47=imresize(y1,[49 49],'nearest');  % 49x49
y41=y47(5:45,5:45);        %     <============ 41x41 orignal data
%
% 純 QR image (492x492)
%
y492QR=imresize(y41,12,'nearest');


k0=imread('lin160615.jpg');      % input 492x492 grayscale image
%k1=imresize(k0,2);    % 492x492  放大兩倍測試
k1=imresize(k0,[492 492]);
x=rgb2gray(k1);
%}
% ---------------------------------------------

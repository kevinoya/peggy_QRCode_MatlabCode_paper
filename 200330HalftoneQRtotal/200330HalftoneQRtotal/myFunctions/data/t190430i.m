...
ss=0.5;
%
dat(:,:,:,1)=imresize(myModule756w(k30,TT1,26),ss);
...
%
dat(:,:,:,7)= imresize(myModule756w(k30,TT1,2),ss);
...
%
dat(:,:,:,25)=imresize(myModule756w(imrotate(imread('20.JPG'),-90),TT1,20),ss);
...
dat(:,:,:,30)=imresize(myModule756w(imrotate(imread('25.JPG'),-90),TT1,25),ss);
%
%
m=84;  % offset
n=816;

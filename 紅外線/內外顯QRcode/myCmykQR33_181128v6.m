...
aa=(660-492)/2;
k5=k5a(aa+1:aa+492,aa+1:aa+492,:);   % 只抓出 396x396 做加密處理
zz=myQR33HideColorB_181128v6(k5,y41,m7);   % <=====  主要處理程序
%
k5a(aa+1:aa+492,aa+1:aa+492,:)=zz;
...
binL=imread('binQR41_660.tif');
LL=imread('QRfinderColor_v6.tif');  % 黑白
LL1=LL(:,:,1)==0;  % binary
